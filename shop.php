<?php
	...
	// 		'Kruzo Aero Chair' => 0,
	// 		'Ergonomic Chair' => 0,
	// 		'Gold Velvet Sofa Seater 3' => 0,
	// 		'Dell Inspiron 15 5510' => 0
	// 	];
	// } else {
	// 	$uselist = unserialize($_COOKIE['uselist']);
	// }
	// echo $_POST['current_product'];
	// if (isset($_POST['current_product'])) {
	// 	$current = $_POST['current_product'];
	// 	if (isset($uselist[$current])) {
	// 		$uselist[$current]++;
	// 	} else {
	// 		$uselist[$current] = 1;
	// 	}
...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<?php
		// if(!isset($_COOKIE['uselist'])){
    	// 	echo "<div style='margin:50px 80px'><h2>Not visited any products</h2></div>";

		// } else {
		// 	echo "<div style='margin:50px 80px'><h2>Most Visited Products:</h2><br/><p>";
		// 	$uselist=unserialize($_COOKIE['uselist']);
		...
		// 			print(($i+1).') '.$mostvisitednames[$i].'  :  '.$mostvisitedcount[$i].' times');
		// 			echo "<br/>";
	...
	<?php
		...
		// 	echo "<div style='margin:50px 80px'><h2>Not visited any products</h2></div>";
		// } else {
		// 	echo "<div style='margin:50px 80px'><h2>Last Five Visited Products:</h2><br/><p>";
		// 	$last5list=unserialize($_COOKIE['last5list']);
		// 	for($i=0;$i<5;$i++){
		// 		if($last5list[$i]!=''){
		      	...
		      	<div class="row">
					<?php
						...
						while($row = mysqli_fetch_assoc($result_query)) {
							...
							// store_visited_products($product_name);
