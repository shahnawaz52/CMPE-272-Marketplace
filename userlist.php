  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
		...
		<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
            ...
            <li class="active"><a class="nav-link" href="userlist.php">User List</a></li>
					</ul>
		...
		if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) {
			// User is logged in, display user list and logout button
			...
			echo "<h3 class='text-center mt-5'>Please <a href='login.php'>login</a> to view user list</h3>";
		}
